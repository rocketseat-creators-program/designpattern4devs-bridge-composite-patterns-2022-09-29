...
import composite.folders.model.FileItem;
...
public class Client {
    ...
    public static FileItem createCompositeFromFile(File file) {
        if(!file.isDirectory()) return new composite.folders.model.File(file.getName());
    ...
    public static void main(String[] args) {
        FileItem file1 = new composite.folders.model.File("Texto1.txt");
        FileItem file2 = new composite.folders.model.File("Texto2.txt");
        FileItem file3 = new composite.folders.model.File("Texto3.txt");
        FileItem file4 = new composite.folders.model.File("Texto4.txt");
